...
public class ProductoService {
    ...
    // 4 consulta de existencias se utiliza un parametro para verificar que en caso de que sea existerncias, mostrar la tarjeta de existencias
    @Transactional(readOnly = true)
public List<Producto> productosConExistencias(int existenciasMin){
    return productoRepository.productosConExistencias(existenciasMin);
}
}
